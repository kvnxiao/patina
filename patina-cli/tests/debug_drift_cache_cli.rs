//! Integration tests for `debug_drift_cache_cli`.
#![expect(
    clippy::expect_used,
    reason = "Integration tests use .expect() for fixtures outside #[cfg(test)] modules; allow-expect-in-tests does not cover integration-crate roots."
)]
